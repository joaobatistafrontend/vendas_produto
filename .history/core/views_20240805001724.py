...
def vendasSemana():
    ...
    return (vendas_semana, total_semana)
...
class DetalhesDias(TemplateView):
    ...
    def get(self, request):
        ...
        return render(request, self.template_name, {'vendas_dia':vendas_dia, 'total_dia':total_dia,
            ...
            'total_mes': vendasMes,
            'vendas_mensais': vendasMes, 'totalVendas':totalVendas})

class DetalhesSemana(TemplateView):
    template_name = 'detalhesSemana.html'
    def get(self, request):
        return render(request, self.template_name, {'vendasSemana':vendasSemana, 'total_dia': vendasDia, 'total_mes': vendasMes})
